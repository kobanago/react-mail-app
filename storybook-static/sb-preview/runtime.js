...
var require_has_proto = __commonJS({
  '../../node_modules/has-proto/index.js'(exports, module) {
    ...
    module.exports = function () {
      return (
        { __proto__: test }.foo === test.foo && !({ __proto__: null } instanceof $Object)
      );
    };
  },
});
    ...
    (function (e, o) {
      typeof exports == 'object' && typeof module < 'u'
        ...
        : typeof define == 'function' && define.amd
          ? define(o)
          : ((e = typeof globalThis < 'u' ? globalThis : e || self).BrowserDetector =
              o());
    })(exports, function () {
      'use strict';
      function e(e2, o2) {
        ...
        t = (function () {
          function t2(e2) {
            ...
            (function (e3, o3) {
              ...
              (this.userAgent =
                e2 ||
                ((o2 = i()) === null || o2 === void 0 ? void 0 : o2.userAgent) ||
                null);
          }
          var a, l, s;
          return (
  ...
  PostMessageTransport = class {
    ...
    getCurrentFrames() {
      return this.config.page === 'manager'
        ? Array.from(document2.querySelectorAll('[data-is-storybook="true"]')).flatMap(
    ...
    getLocalFrame() {
      return this.config.page === 'manager'
        ? Array.from(document2.querySelectorAll('#storybook-preview-iframe')).flatMap(
            (e) => (e.contentWindow ? [e.contentWindow] : []),
          )
        : scope && scope.parent
          ? [scope.parent]
  ...
  Preview = class {
    ...
    async onGetProjectAnnotationsChanged({ getProjectAnnotations }) {
      ...
      let projectAnnotations =
        await this.getProjectAnnotationsOrRenderError(getProjectAnnotations);
