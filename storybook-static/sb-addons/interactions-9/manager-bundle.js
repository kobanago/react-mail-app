try {
  (() => {
    ...
    function xn(e, t, r, n) {
      ...
      if (typeof e == 'object' && t === void 0 && r === void 0 && n === void 0)
        return e.alpha >= 1
          ...
          : 'rgba(' + rt(e.hue, e.saturation, e.lightness) + ',' + e.alpha + ')';
      throw new ve(2);
    }
    function zt(e, t, r) {
      if (typeof e == 'number' && typeof t == 'number' && typeof r == 'number')
    ...
    function $n(e, t) {
      if (t === 'transparent') return t;
      var r = Fe(t);
      return Me(be({}, r, { lightness: Ke(0, 1, r.lightness - parseFloat(e)) }));
    }
    var Gs = Oe($n);
    function kn(e, t) {
      if (t === 'transparent') return t;
      var r = Fe(t);
      return Me(be({}, r, { saturation: Ke(0, 1, r.saturation - parseFloat(e)) }));
    }
    var Us = Oe(kn);
    function Fn(e, t) {
      if (t === 'transparent') return t;
    ...
    function zn(e, t) {
      ...
      var r = Ve(t),
        ...
        a = be({}, r, { alpha: Ke(0, 1, (n * 100 + parseFloat(e) * 100) / 100) });
      return bt(a);
    }
    var Vs = Oe(zn);
    function Bn(e, t) {
    ...
    var Vn = Object.create,
      ...
      xe = (e, t, r) => (
        (r = e != null ? Vn(Jn(e)) : {}),
        Zn(
          t || !e || !e.__esModule ? zr(r, 'default', { value: e, enumerable: !0 }) : r,
          e,
        )
      ),
      Ut = Ce({
      ...
      Ge = (e, t, r) => (
        (r = e != null ? ua(pa(e)) : {}),
        da(
          t || !e || !e.__esModule ? Dr(r, 'default', { value: e, enumerable: !0 }) : r,
          e,
        )
      ),
      ga = ye({
            ...
            if (v.length) {
              ...
              for (let y = 0; y < v.length; y++) {
                let S = v[y],
                  ...
                  O = b(o[S], c, d, f, h);
                (m += `${d + _}: ${O}`),
                  y < v.length - 1 ? (m += `,${c.spacingInner}`) : c.min || (m += ',');
              }
              m += c.spacingOuter + p;
            }
            return m;
      ...
      ba = ye({
        '../../node_modules/pretty-format/build/plugins/AsymmetricMatcher.js'(e) {
          ...
          var t = St(),
            ...
            n =
              typeof r == 'function' && r.for ? r.for('jest.asymmetricMatcher') : 1267621,
            a = ' ',
            u = (f, h, b, m, v, d) => {
              let y = f.toString();
      ...
      ha = ye({
        '../../node_modules/pretty-format/build/plugins/DOMCollection.js'(e) {
          ...
          var t = St(),
            ...
            o = (b) =>
              b && b.constructor && !!b.constructor.name && u(b.constructor.name);
          e.test = o;
            ...
            p = (m, v, d, y, S, _) =>
              ++y > v.maxDepth
                ...
                : (0, r.printElement)(
                    ...
                    (0, r.printChildren)(u(m.props.children), v, d + v.indent, y, S, _),
                    v,
                    d,
                  );
          e.serialize = p;
            ...
            u = (f, h, b, m, v, d) =>
              ++m > h.maxDepth
                ...
                : (0, t.printElement)(
                    f.type,
                    f.props
                      ? (0, t.printProps)(a(f), f.props, h, b + h.indent, m, v, d)
                      : '',
                    f.children
                      ? (0, t.printChildren)(f.children, h, b + h.indent, m, v, d)
                      : '',
                    h,
                    b,
                  );
      ...
      Kt = ye({
        '../../node_modules/pretty-format/build/index.js'(e) {
          ...
          var h = Object.prototype.toString,
            ...
            d = (g) =>
              (typeof g.constructor == 'function' && g.constructor.name) || 'Object',
        ...
        '../../node_modules/diff-sequences/build/index.js'(e) {
          ...
          var t = 'diff-sequences',
                ...
                if (((B = N[L]), (N[L] = ne), D <= ee && ee <= G)) {
                  ...
                  if (pe <= T && k[pe] - 1 <= ne) {
                    ...
                    (E.nChangePreceding = d - 1),
                      ...
                      Z !== 0 &&
                        ((E.aCommonFollowing = I + 1), (E.bCommonFollowing = K + 1));
                    let F = ne + 1,
                      W = K + Z + 1;
                    return (
            ...
            b = (d, y) => {
              ...
              if (y < 0)
                throw new RangeError(`${t}: ${d} value ${y} is a negative integer`);
            },
            m = (d, y) => {
              let S = typeof y;
              if (S !== 'function')
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
            ...
            function me(l) {
              return (
                Z[l] ||
                '\\u'.concat('0000'.concat(l.charCodeAt(0).toString(ne)).slice(-pe))
              );
            }
            function le(l, s) {
              return (
...
`,
    ...
    var Y = ((e) => (
      ...
      at = J(Pt)(({ theme: e }) => ({ color: e.textMutedColor, margin: '0 3px' })),
      ka = J(Er)({ marginTop: 0 }),
      Fa = J(hr)(({ theme: e }) => ({
        color: e.textMutedColor,
    ...
    var Xt = (e) =>
      ...
      vt = (e) => {
        let {
          ...
          h = (0, Va.default)(e, Ja),
          { themeClass: b, currentTheme: m } = wt({ theme: t, colorScheme: n }, Se),
          [v, d] = Pe(f);
        Be(() => {
          d(f);
        }, [f]);
        ...
        return (
          Be(() => {
            t.value instanceof Promise &&
              (async (b) => {
                f(_e(t.key, `Promise { "${await Ur(b)}" }`, te.key, n, t.depth));
              })(t.value);
          }, [t, n]),
    ...
    var Vr = Yr,
      ...
      Kr = (e) => {
        let {
          ...
          c = (0, eo.default)(e, to),
          { themeClass: p, currentTheme: f } = wt({ theme: r, colorScheme: u }, te),
          h = t.isPrototype || !1,
            ...
            (async () => {
              if (t.type !== 'value') {
                let p = t.children.map((b) => b()),
                  ...
                  h = (0, $r.default)((0, $r.default)({}, t), {}, { children: f });
                u(h);
              }
            })();
          }, [t]),
...
`);
      ...
      zo = J('div', {
        ...
        ({ theme: e, call: t }) => ({
          ...
          ...(t.status === Y.ERROR && {
            backgroundColor:
              e.base === 'dark' ? ht(0.93, e.color.negative) : e.background.warning,
          }),
        ...
        return H(
          ...
          e.showDiff && e.diff
            ...
            : H(
                ...
                e.actual &&
                  H($e, null, 'Received: ', H(yt, { value: e.actual }), H('br', null)),
              ),
