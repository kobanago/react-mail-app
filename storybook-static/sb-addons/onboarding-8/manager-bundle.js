try {
  (() => {
    ...
    var cy = (t, e, n) => (
        (n = t != null ? ry(ay(t)) : {}),
        Kl(
          e || !t || !t.__esModule ? Wr(n, 'default', { value: t, enumerable: !0 }) : n,
          t,
        )
      ),
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
                    ...
                    },
                    {
                      ...
                      value: function () {
                        ...
                        return s.a.createElement(
                          'canvas',
                          N(
                            { width: it.width, height: it.height, ref: this.canvas },
                            lt,
                            { style: ot },
                          ),
                        );
    ...
    var xy = Object.create,
      ...
      le = (t, e, n) => (
        (n = t != null ? xy(Py(t)) : {}),
        yf(
          e || !t || !t.__esModule ? Jo(n, 'default', { value: t, enumerable: !0 }) : n,
          t,
        )
      ),
    ...
    function Ny(t, e) {
      ...
      for (
        var n = new DataView(t.buffer), r = new DataView(e.buffer), o = t.byteLength;
        o--;
    ...
    function cu(t, e, n) {
      ...
      return (
        F.undefined(r) || (u = u && l === r), F.undefined(i) || (u = u && s === i), u
      );
    }
    function pu(t, e, n) {
      var r = n.key,
    ...
    function fu(t, e, n) {
      ...
      return (
        [i, a].every(F.plainObject) && ((i = Object.keys(i)), (a = Object.keys(a))),
        [i, a]
      );
    }
    function du(t) {
    ...
    var mu,
      ...
      Cf = ee((t, e) => {
        ...
        function m(b, w) {
          return (
            h(b, w) &&
            !(Object.hasOwnProperty.call(b, w) && Object.propertyIsEnumerable.call(b, w))
          );
        }
        function y(b, w, O) {
          var S = {};
    ...
    function e0(t, e) {
      var n = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : !1,
        ...
        i = n ? -1 : 1;
      return (
        (t.top += r * i), (t.bottom += r * i), (t.left += o * i), (t.right += o * i), t
      );
    }
    function vu(t, e) {
      var n = e === 'x' ? 'Left' : 'Top',
    ...
    function Cs(t, e) {
      ...
      return (
        (r && !n ? e.contains(s) : e === s && s.nodeName !== 'BODY') && (f = e0(f, e)), f
      );
    }
    function n0(t) {
                  ...
                  if (!F.boolean(s)) {
                    ...
                    (o.event === 'click' || (o.event === 'hover' && u)) &&
                      (qr({
                        title: 'click',
                        data: [
                          { event: a, status: c === J.OPEN ? 'closing' : 'opening' },
                        ],
                        debug: o.debug,
                      }),
                      o.toggle());
          ...
          function o() {
            ...
            me(this, o),
              ...
              H(this, 'open', function () {
                ...
                d === K.RUNNING &&
                  i.setState(
                    D({}, i.getNextState({ action: tt.UPDATE, lifecycle: _.TOOLTIP })),
                  );
              }),
    ...
    function J0() {
      ...
      window.innerWidth > 480 && (n = 380),
        e.width &&
          (window.innerWidth < e.width ? (n = window.innerWidth - 30) : (n = e.width));
      var r = {
          bottom: 0,
          left: 0,
          overflow: 'hidden',
              ...
              ve(n, [
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    var d = p.overlay;
                    Vu() &&
                      (d = f === 'center' ? p.overlayLegacyCenter : p.overlayLegacy);
                    var h = D(
                        {
                    ...
                    return (
                      ...
                      b &&
                        ...
                        (rt.skip = g.createElement(
                          'button',
                          Bt(
                            { style: O.buttonSkip, type: 'button', 'aria-live': 'off' },
                            f,
                          ),
                          et,
                        )),
                      ...
                      (rt.close =
                        !y && g.createElement(tb, Bt({ styles: O.buttonClose }, i))),
                      g.createElement(
                        'div',
                        Bt(
                          {
...
`);
    ...
    function Eb(t, e = globalThis?.document) {
      ...
      W(() => {
        ...
        return (
          e.addEventListener('keydown', r), () => e.removeEventListener('keydown', r)
        );
      }, [n, e]);
    }
    var xb = v(() => {
    ...
    function Sb(t, e = globalThis?.document) {
      ...
      return (
        W(() => {
          ...
          return (
            e.addEventListener('focusin', o), () => e.removeEventListener('focusin', o)
          );
        }, [e, n]),
    ...
    function l1(t) {
        ...
        W(
          function () {
            if (t.inert) {
              ...
              var m = $t([t.lockRef.current], (t.shards || []).map(Ya), !0).filter(
                Boolean,
              );
              return (
      ...
      var s = xt(function (m, y) {
          ...
          if ((N ? (O = M) : ((O = M === 'v' ? 'h' : 'v'), (N = Ha(M, S))), !N))
            return !1;
          if ((!r.current && 'changedTouches' in m && (b || w) && (r.current = O), !O))
            return !0;
          var B = r.current || O;
...
`;
      ...
      w1 = ee((t, e) => {
        function n(r, o, i) {
          ...
          var p = function () {
            ...
            var d = i && !a;
            return (
              a || (a = setTimeout(f, o)), d && ((c = r.apply(l, s)), (l = s = null)), c
            );
          };
          return (
            (p.clear = function () {
    ...
    function lw(t) {
      ...
      return (
        ...
        n !== void 0
          ? n
          : 0) +
          ((o = (r = t.match(zo)) === null || r === void 0 ? void 0 : r.length) !==
            null && o !== void 0
            ? o
            : 0) >
          0
    ...
    function op(t, e, n) {
      return function (r, o) {
        ...
        !Sm(r) ||
          Im() ||
          ((i = t.animationState) === null || i === void 0 || i.setActive(st.Hover, e),
          n?.(r, o));
      };
    }
    function Hw(t) {
      ...
      function m() {
        ...
        if ((o === void 0 && (o = Math.min(Math.abs(n - e) / 100, 0.4)), x < 1)) {
          ...
          (d = (O) => {
            ...
            return (
              n - S * (((y + x * b * E) / w) * Math.sin(w * O) + E * Math.cos(w * O))
            );
          }),
            (h = (O) => {
              let S = Math.exp(-x * b * O);
              return (
                x *
                  b *
                  S *
                  ((Math.sin(w * O) * (y + x * b * E)) / w + E * Math.cos(w * O)) -
    ...
    function qE(t, e) {
      var n,
        r,
        o = Dl(t, e) || {};
      return (r = (n = o.delay) !== null && n !== void 0 ? n : t.delay) !== null &&
        r !== void 0
        ? r
        : 0;
    }
    ...
    function Ap(t) {
      return (
        t === 0 || (typeof t == 'string' && parseFloat(t) === 0 && t.indexOf(' ') === -1)
      );
    }
    function kp(t) {
    ...
    function Fv(t, e, n) {
      ...
      var h = [],
        m =
          l &&
          ((r = t.animationState) === null || r === void 0 ? void 0 : r.getState()[l]);
      for (var y in d) {
        var E = t.getValue(y),
          x = d[y];
      ...
      for (var o in e) {
        ...
        if (ce(i)) t.addValue(o, i);
          ...
          if (t.hasValue(o)) {
            ...
            t.addValue(o, jn((r = t.getStaticValue(o)) !== null && r !== void 0 ? r : i));
      }
            ...
            if (!this.projectionDelta || !this.layout || !y.target) {
              ...
              return (
                this.options.layoutId &&
                  ((E.opacity =
                    (u = this.latestValues.opacity) !== null && u !== void 0 ? u : 1),
    ...
    function fO(t) {
      var e,
        ...
        o,
        i =
          (n = (e = t.resumeFrom) === null || e === void 0 ? void 0 : e.snapshot) !==
            null && n !== void 0
            ? n
            : t.snapshot;
      if (t.isLead() && t.layout && i && t.hasListeners('didUpdate')) {
        ...
        t.isLead() &&
          ((o = (r = t.options).onExitComplete) === null || o === void 0 || o.call(r));
          ...
          (Jg = ({
            ...
            let [i, a] = at('imports'),
              ...
              E = () => {
                ...
                navigator.clipboard.writeText(b.replace('// Copy the code below', '')),
                  c(!0);
              },
              x = xt(() => {
                e.emit(xn, {
      ...
      return (
        W(() => {
          (async () => {
            try {
              let n =
                (await (await fetch('/project.json')).json())?.language === 'javascript'
                  ? Zg
                  : $g;
              e({ data: n, error: null });
            } catch (n) {
