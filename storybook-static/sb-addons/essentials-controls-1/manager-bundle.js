  ...
  (() => {
    ...
    var Rs = S((mq, Os) => {
      ...
      function uE(e, t) {
        var r = this.__data__;
        return (
          (this.size += this.has(e) ? 0 : 1), (r[e] = oE && t === void 0 ? iE : t), this
        );
      }
      Os.exports = uE;
    });
              ...
              function (n, a, o) {
                ...
                a.exports = function (y) {
                  ...
                  return function (h) {
                    ...
                    return (
                      (E.limit = y), (E.wasMemoized = !1), (E.cache = A), (E.lru = m), E
                    );
                  };
                };
                function u(y, A) {
      ...
      var Ko = function () {
        ...
        Dt = {
          ...
          '%MapIteratorPrototype%':
            typeof Map > 'u' || !zt || !Ee ? ee : Ee(new Map()[Symbol.iterator]()),
          '%Math%': Math,
          '%Number%': Number,
          '%Object%': Object,
          ...
          '%SetIteratorPrototype%':
            typeof Set > 'u' || !zt || !Ee ? ee : Ee(new Set()[Symbol.iterator]()),
        ...
        for (var y = 1, A = !0; y < n.length; y += 1) {
          ...
          if (
            ...
            if (vt && y + 1 >= n.length) {
              var b = vt(u, m);
              (A = !!b),
                A && 'get' in b && !('originalValue' in b.get) ? (u = b.get) : (u = u[m]);
            } else (A = $n(u, m)), (u = u[m]);
            A && !s && (Dt[i] = u);
          }
        }
    ...
    var yh = S((EX, gh) => {
      ...
      var NT = Xo()(),
        Zo = ut(),
        Ir = NT && Zo('%Object.defineProperty%', !0);
      if (Ir)
        try {
          Ir({}, 'a', { value: 1 });
        } catch {
    ...
    var Ch = S((CX, Dh) => {
      ...
      Dh.exports = function (t, r) {
        ...
        return (
          (a || o || !n) && (qT ? bh(t, 'length', r, !0, !0) : bh(t, 'length', r)), t
        );
      };
    });
    var Bh = S((wX, Hn) => {
      ...
      var ei = Mn(),
        ...
        wh = Kt('%Reflect.apply%', !0) || ei.call(Fh, Sh),
    ...
    var Zh = S((MX, Qh) => {
      ...
      Qh.exports = function e(t, r, n, a) {
        ...
        function m(Y, R, _) {
          if ((R && ((a = QT.call(a)), a.push(R)), _)) {
            var M = { depth: o.depth };
            return (
              st(o, 'quoteStyle') && (M.quoteStyle = o.quoteStyle), e(Y, M, n + 1, a)
            );
          }
          return e(Y, o, n + 1, a);
        }
        ...
        if (Yh(t)) {
          var b = Yt ? lt.call(String(t), /^(Symbol\(.*\))_[^)]*$/, '$1') : ii.call(t);
      ...
      function a8(e) {
        return (
          ct(e) === '[object Boolean]' && (!Ce || !(typeof e == 'object' && Ce in e))
        );
      }
      function Yh(e) {
...
` +
        ...
        k8 = function (t, r, n, a, o) {
          ...
          for (var u = '', s = 0; s < i.length; ++s) {
            ...
            if (p < 55296 || p >= 57344) {
              u =
                u +
                (We[224 | (p >> 12)] + We[128 | ((p >> 6) & 63)] + We[128 | (p & 63)]);
              continue;
            }
            (s += 1),
        ...
        Z8 = function (t, r, n, a) {
          if (t) {
            var o = n.allowDots ? t.replace(/\.([^.[]+)/g, '[$1]') : t,
              ...
              y = [];
            if (p) {
              if (!n.plainObjects && Ei.call(Object.prototype, p) && !n.allowPrototypes)
                return;
              y.push(p);
            }
          ...
          return {
            ...
            allowPrototypes:
              typeof t.allowPrototypes == 'boolean'
                ...
                : Ae.allowPrototypes,
            allowSparse:
              typeof t.allowSparse == 'boolean' ? t.allowSparse : Ae.allowSparse,
            ...
            plainObjects:
              typeof t.plainObjects == 'boolean' ? t.plainObjects : Ae.plainObjects,
            strictNullHandling:
              typeof t.strictNullHandling == 'boolean'
                ? t.strictNullHandling
    ...
    var Cm = S((nee, Dm) => {
      ...
      (function () {
        ...
        function u(m) {
          var h, E, b;
          if (m.length === 0 || ((b = m.charCodeAt(0)), !e.isIdentifierStartES5(b)))
            return !1;
        ...
        function p(m) {
          ...
          for (F = e.isIdentifierStartES6, h = 0, E = m.length; h < E; ++h) {
            if (((b = m.charCodeAt(h)), 55296 <= b && b <= 56319)) {
              if ((++h, h >= E || ((x = m.charCodeAt(h)), !(56320 <= x && x <= 57343))))
                return !1;
              b = s(b, x);
            }
            if (!F(b)) return !1;
...
`;
        ...
        function B() {
          ...
          if (((T = ''), (P = r.charCodeAt(a)), P !== 46)) {
            if (((T = b()), (P = r.charCodeAt(a)), T === '0')) {
              if (P === 120 || P === 88) {
                for (T += b(); a < n && ((P = r.charCodeAt(a)), !!s.code.isHexDigit(P)); )
                  T += b();
                return (
        ...
        function ae() {
          var T,
            P = a - 1,
            L;
          if ((w(t.LBRACE, 'RecordType should start with {'), (T = []), i === t.COMMA))
            w(t.COMMA);
        ...
        function X() {
          ...
          switch (i) {
            ...
            case t.STRING:
              return (
                q(), E({ type: e.StringLiteralType, value: u }, [o - u.length - 2, o])
              );
            case t.NUMBER:
              return (
                q(),
                E({ type: e.NumericLiteralType, value: u }, [o - String(u).length, o])
              );
            default:
              p.throwError('unexpected token');
          }
...
\u2028\u2029])`;
        ...
        (function (w) {
          ...
          function K(L) {
            var O;
            if (!n.code.isIdentifierStartES5(U.charCodeAt(k)) && !U[k].match(/[0-9]/))
              return null;
            for (O = _(); k < L && n.code.isIdentifierPartES5(U.charCodeAt(k)); )
              O += _();
            return O;
          }
          function Z(L) {
          ...
          (Q.prototype.addError = function (O) {
            var $ = Array.prototype.slice.call(arguments, 1),
              H = O.replace(/%(\d)/g, function (de, ne) {
                return (
                  t.assert(ne < $.length, 'Message reference must be in range'), $[ne]
                );
              });
            return (
            ...
            (Q.prototype.parseDescription = function () {
              ...
              return (
                O &&
                  (/^-\s+/.test(O) && (O = O.substring(2)), (this._tag.description = O)),
                !0
              );
            }),
    ...
    var eg = S((Kee, Zm) => {
      ...
      Zm.exports = function (e) {
        ...
        function m(B) {
          ...
          return (
            B !== null &&
              ((I = B.offsetTop), e.hasInnerContainers && (I += m(B.offsetParent))),
            I
          );
        }
        function h(B, I) {
    ...
    var rg = S((Qee, tg) => {
      ...
      tg.exports = function (t) {
        ...
        function o(y) {
          try {
            return (
              y instanceof window.HTMLElement || y instanceof window.parent.HTMLElement
            );
          } catch {
    ...
    var Ne,
      ...
      ry = Ke(() => {
        ...
        (h4 = j.div({ position: 'relative', maxWidth: 250 })),
          (m4 = j(Jr)({ position: 'absolute', zIndex: 1, top: 4, left: 4 })),
          (g4 = j.div({
            width: 200,
            margin: 5,
          ...
          (_4 = (e, t, r) => {
            ...
            let o = et(
              ...
              i = me(
                (u) => {
                  u?.valid &&
                    (o.some((s) => sa(s[r]) === sa(u[r])) || a((s) => s.concat(u)));
                },
                [r, o],
              );
    ...
    function s1(e, t) {
      if (t === 'transparent') return t;
      var r = tt(t);
      return rt(De({}, r, { lightness: _t(0, 1, r.lightness - parseFloat(e)) }));
    }
    var l1 = Ie(s1),
      Me = l1;
    function c1(e, t) {
      if (t === 'transparent') return t;
      var r = tt(t);
      return rt(De({}, r, { saturation: _t(0, 1, r.saturation - parseFloat(e)) }));
    }
    var _7 = Ie(c1);
    function d1(e, t) {
      if (t === 'transparent') return t;
    ...
    function m1(e, t) {
      ...
      var r = Tt(t),
        ...
        a = De({}, r, { alpha: _t(0, 1, (n * 100 + parseFloat(e) * 100) / 100) });
      return je(a);
    }
    var g1 = Ie(m1),
      fr = g1;
    ...
    var mS = Object.create,
      ...
      DS = (e, t, r) => (
        (r = e != null ? mS(bS(e)) : {}),
        vS(
          t || !e || !e.__esModule ? Md(r, 'default', { value: e, enumerable: !0 }) : r,
          e,
        )
      ),
      CS = AS((e) => {
                ...
                switch (h.slice(8, -1)) {
                  ...
                  case 'Array':
                    ...
                    for (m = 0; m < u.length; m++)
                      if ((m in u || m in s) && (m in u != m in s || !i(u[m], s[m], p)))
                        return !1;
                    return !0;
                  case 'Object':
                    return i(r(u), r(s), p);
                  ...
                  N = (b[w] = (function (k, z) {
                    return k === 'style'
                      ? z.split(/;\s?/).reduce(function (V, U) {
                          ...
                          return (
                            (V[ae.replace(/(-[a-z])/g, (J) => J[1].toUpperCase())] =
          ...
          3: {
            ...
            render: (h, E, b) =>
              n(
                ...
                n(
                  'code',
                  Et({}, h.attrs, { className: h.lang ? `lang-${h.lang}` : '' }),
                  h.text,
                ),
              ),
          },
          ...
          24: {
            ...
            render: (h, E, b) =>
              u[h.ref]
                ? n(
                    'a',
                    { key: b.key, href: Mt(u[h.ref].target), title: u[h.ref].title },
                    E(h.children, b),
                  )
...
`,
    ...
    var z3 = Object.create,
      ...
      Yf = (e, t, r) => (
        (r = e != null ? z3(G3(e)) : {}),
        V3(
          t || !e || !e.__esModule ? Vf(r, 'default', { value: e, enumerable: !0 }) : r,
          e,
        )
      );
    function Jf() {
          ...
          var y =
            ...
            A =
              String.prototype.codePointAt != null
                ...
                : function (B) {
                    return (
                      (B.charCodeAt(0) - 55296) * 1024 + B.charCodeAt(1) - 56320 + 65536
                    );
                  };
          function m(B) {
            return (
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
    ...
    var w_ = `${Tm}/snippet-rendered`,
      _m = ((e) => ((e.AUTO = 'auto'), (e.CODE = 'code'), (e.DYNAMIC = 'dynamic'), e))(
        _m || {},
      );
    l();
    c();
    ...
    var B_ = Object.create,
      ...
      Zn = (e, t, r) => (
        (r = e != null ? B_(__(e)) : {}),
        R_(
          t || !e || !e.__esModule ? Om(r, 'default', { value: e, enumerable: !0 }) : r,
          e,
        )
      ),
      P_ = [
    ...
    function s6(e) {
      var t = this.__data__;
      return zr ? t[e] !== void 0 : u6.call(t, e);
    }
    var l6 = s6,
    ...
    function d6(e, t) {
      var r = this.__data__;
      return (
        (this.size += this.has(e) ? 0 : 1), (r[e] = zr && t === void 0 ? c6 : t), this
      );
    }
    var p6 = d6;
    function Zt(e) {
    ...
    Zt.prototype.clear = QO;
    Zt.prototype.delete = e6;
    Zt.prototype.get = o6;
    Zt.prototype.has = l6;
    Zt.prototype.set = p6;
    var qm = Zt;
    ...
    tr.prototype.clear = _6;
    tr.prototype.delete = k6;
    tr.prototype.get = L6;
    tr.prototype.has = j6;
    tr.prototype.set = $6;
    var Vm = tr,
...
` &&
    ...
    var R4 = j.div(Bt, ({ theme: e }) => ({
      ...
      Cy = (e) =>
        g.createElement(R4, { ...e, className: 'docblock-emptyblock sb-unstyled' }),
      P4 = j(Yr)(({ theme: e }) => ({
    ...
    var M4 = j.div(
      ...
      ny = j(xy)(({ theme: e }) => ({
        ...
        border: 'none',
        background:
          e.base === 'light' ? 'rgba(0, 0, 0, 0.85)' : Me(0.05, e.background.content),
    ...
    var V4 = j.table(({ theme: e }) => ({
      ...
      i9 = ({ name: e, value: t, onChange: r, onBlur: n, onFocus: a }) => {
        let o = me(() => r(!1), [r]);
        if (t === void 0)
          return g.createElement(Te.Button, { id: lr(e), onClick: o }, 'Set boolean');
        let i = _e(e),
    ...
    var m9 = ({
        ...
        return (
          ...
          !y && t === void 0
            ? g.createElement(Te.Button, { id: lr(e), onClick: b }, 'Set number')
            : g.createElement(
                f9,
                null,
                g.createElement(Te.Input, {
      ...
      uy = ({ name: e, options: t, value: r, onChange: n, isInline: a }) => {
        if (!t)
          return (
            ze.warn(`Radio with no options: ${e}`), g.createElement(g.Fragment, null, '-')
          );
        let o = Fy(r, t),
          i = _e(e);
        return g.createElement(
    ...
    var { window: z9 } = ie,
      ...
      py = ({ name: e, value: t, onChange: r }) => {
        ...
        if (
          ...
          return g.createElement(Te.Button, { id: lr(e), onClick: h }, 'Set object');
    ...
    var tP = ({
      ...
      aP = ({ name: e, value: t, onChange: r, onFocus: n, onBlur: a, maxLength: o }) => {
        ...
        if (t === void 0)
          return g.createElement(Te.Button, { id: lr(e), onClick: p }, 'Set string');
        ...
        return g.createElement(
          ...
          o &&
            g.createElement(nP, { isMaxed: t?.length === o }, t?.length ?? 0, ' / ', o),
        );
      },
    ...
    var uP = ({ onChange: e, name: t, accept: r = 'image/*', value: n }) => {
      ...
      ca = (e) => {
        ...
        return g.createElement(
          ...
          a
            ? g.createElement('td', null, g.createElement(dP, { ...e, isHovered: t }))
            : null,
        );
      },
      bP = j(Be)(({ theme: e }) => ({
      ...
      NP = (e, t) => {
        ...
        let n = kP[t],
          a = (o) =>
            n ? Object.keys(o).reduce((i, u) => ({ ...i, [u]: o[u].sort(n) }), {}) : o;
        return {
          ...
          g.createElement(
            ...
            g.createElement(
              ...
              g.createElement(
                ...
                n
                  ? null
                  : g.createElement('th', null, g.createElement('span', null, 'Default')),
                t
                  ? g.createElement(
                      'th',
                      null,
          ...
          : g.createElement(
              ...
              r.map((n) => {
                ...
                return g.createElement(
                  ...
                  ({ active: u }) =>
                    u
                      ? g.createElement(St, { key: `prop_table_${a}`, ...o, ...t })
                      : null,
                );
              }),
            );
      ...
      HP = (e) => {
        ...
        try {
          ...
          let y = jP(p, t),
            ...
            [E] = UP(t);
          if (!y)
            return g.createElement(St, { isLoading: !0, updateArgs: m, resetArgs: h });
  ...
  `);
        ...
        let { include: o, exclude: i, components: u, sort: s } = e,
          ...
          A = zP(e, n);
        if (p)
          return g.createElement(HP, { ...e, component: A, subcomponents: a, sort: y });
        if (!u && !a) {
          let h;
          try {
            h = { rows: My(A, r, o, i) };
        ...
        if (u)
          return g.createElement(gy, { ...e, components: u, sort: y, parameters: r });
        let m = jy(A);
    ...
    var nne = ur({ sources: {} });
    var WP = ((e) => ((e.OPEN = 'open'), (e.CLOSED = 'closed'), (e.NONE = 'none'), e))(
      WP || {},
    );
    var { document: VP } = ie;
    function KP(e, t) {
